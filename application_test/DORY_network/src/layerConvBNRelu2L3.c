  ...
  for(int j=0; j<7; j++) 
  {
    ...
    if (j==0)
    {
      unsigned int args[13] = {l3_x,
          ...
          exec_input,
          l2_x_2,
          dory_get_tile_3d(exec_output, 0, 0, k, 16, 112, 48, 112, 48, 0, 0, 0, 0, 0, 0, 4),
          exec_weights,
          l1_buffer,
          hyperram,
          outmult,
    ...
    else if (j==(6))
    {
      unsigned int args[13] = {l3_x,
          l3_y,
          l3_W,
          dory_get_tile_3d(exec_input, j, 0, 0, 16, 112, 24, 112, 24, 0, 0,0, 0, 0, 0, 4),
          l2_x_2,
          dory_get_tile_3d(exec_output, 0, 0, k, 16, 112, 48, 112, 48, 0, 0, 0, 0, 0, 0, 4),
          exec_weights,
          l1_buffer,
    ...
    if(pi_core_id()==0) 
    {
      ...
      pi_cl_ram_write(hyperram, (l3_y + j*43008), transfer_output, 43008, &buff_req_y1);
    }
