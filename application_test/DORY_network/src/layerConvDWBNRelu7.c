...
void layerConvDWBNRelu7(
  ...
  im2col = l1_buffer + 35192;
  volatile char *pwt_buffer;
  pwt_buffer = im2col + 1632;
  ...
  DMA_copy_k.loc = (uint32_t) l1_buffer + 34664;
  ...
  DMA_copy_lambda.loc = (uint32_t) l1_buffer + 34928;
  ...
  DMA_copy_x.number_of_2d_copies = 31;
  ...
  DMA_copy_W.ext = l2_W;
  DMA_copy_W.loc = (l1_buffer + 34512) + 0;
...
///////// POSSIBLE BUG FIX!!!!! DB_STATE_Y NOT SWITCHED /////////////
    ...
    if(iter < (total_tiles-1) )
    {
      ...
      x_tile_size_h   = (_i_h_load+1 == 2)   ? 27 : 31;
      ...
      if(_i_w_load > 0)
        pad_offset_w = 1;
      y_tile_size_h   = (_i_h_load+1 == 2)   ? 13 : 15;
      ...
      DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 31, 56, 16, 56, 96,  1, 1,0, pad_offset_h, pad_offset_w, 0, 4);
      ...
      if (_i_nif_load!=_i_nif_exec || _i_nof_load!=_i_nof_exec)
      {
        ...
        DMA_copy_W.loc = (l1_buffer + 34512) + db_W;
    ...
    k = (int64_t *) (l1_buffer + 34664 + exec_db_act);
    lambda = (int64_t *) (l1_buffer + 34928 + exec_db_act);
    W = (char *) (l1_buffer + 34512 + exec_db_W);
    y = (char *) (l1_buffer + 27784 + db_y);
    // parameter passed to the kernel. Input and output sizes
    x_tile_size_nif_exec = (_i_nif_exec+1 == 6) ? 16 : 16;
    x_tile_size_h_exec   = (_i_h_exec+1 == 2)   ? 27 : 31;
    x_tile_size_w_exec   = (_i_w_exec+1 == 1)   ? 56 : 56;
    y_tile_size_nof = (_i_nof_exec+1 == 6) ? 16 : 16;
    y_tile_size_h   = (_i_h_exec+1 == 2)   ? 13 : 15;
    ...
    {                        
      ...
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_exec, _i_w_exec, _i_nof_exec, 15, 28, 16, 28, 96, 0, 0, 0, 0, 0, 0, 4);
