...
void layerGemm28_last(
  ...
  DMA_copy_y.stride_2d = 4000;
  DMA_copy_y.stride_1d = 4000;
  DMA_copy_y.dir = 0;
  ...
  DMA_copy_W.ext = l2_W;
  DMA_copy_W.loc = (l1_buffer + 560) + 0;
  ...
  for(iter=0; iter < total_tiles; iter++) {
    ...
    db_x = !db_state_x ? 384 : 0;
    db_W = !db_state_W ? 15360 : 0;
    db_y = !db_state_y ? 160 : 0;
    exec_db_x = 0;
...
///////// POSSIBLE BUG FIX!!!!! DB_STATE_Y NOT SWITCHED /////////////
    ...
    if(iter < (total_tiles-1) )
    {
      ...
      W_tile_size_nof = (_i_nof_load+1 == 1) ? 40 : 40;
      ...
      if (_i_nif_load!=_i_nif_exec || _i_nof_load!=_i_nof_exec)
      {
        DMA_copy_W.ext = dory_get_tile_3d(l2_W, _i_nof_load, 0, _i_nif_load, 40, 1*1, 768, 1*1, 768, 0,0,0,0,0,0, 4);
        DMA_copy_W.loc = (l1_buffer + 560) + db_W;
    ...
    b = (char *) (l1_buffer + 15944 + _i_nof_exec*40);
    W = (char *) (l1_buffer + 560 + exec_db_W);
    y = (char *) (l1_buffer + 392 + db_y);
    ...
    y_tile_size_nof = (_i_nof_exec+1 == 1) ? 40 : 40;
    ...
    y_length_nof_byte = (_i_nof_exec+1 == 1)   ? 160 : 160;
    p_r = 0;
    p_l = 0;
    p_t = 0;
    p_b = 0;
    ...
    // wait for DMA write/read
      ...
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_exec, _i_w_exec, _i_nof_exec, 1, 1, 40, 1, 1000, 0, 0, 0, 0, 0, 0, 32);
      DMA_copy_y.loc = (l1_buffer + 392) + db_y;
