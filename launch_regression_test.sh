...
echo "MobilenetV1 MAC/cycle: 7.625157"
...
python3 network_generate.py --network_dir './examples/PenguiNet_32/' --Bn_Relu_Bits 32 --sdk gap_sdk
...
python3 network_generate.py --network_dir './examples/PenguiNet_64/' --Bn_Relu_Bits 64 --sdk gap_sdk 
...
python3 network_generate.py --network_dir './examples/dronet_complete/' --Bn_Relu_Bits 64 --sdk gap_sdk --l2_buffer_size 420000
...
python3 network_generate.py --network_dir './examples/dronet_no_pooling/' --Bn_Relu_Bits 64 --sdk gap_sdk --l2_buffer_size 420000
...
python3 network_generate.py --network_dir './examples/Residual_connection_test_1/' --Bn_Relu_Bits 32 --sdk gap_sdk
...
echo "Residual_connection_test_2 MAC/cycle: 4.600245"
python3 network_generate.py --network_dir './examples/Residual_connection_test_2/' --Bn_Relu_Bits 64 --sdk gap_sdk
...
python3 network_generate.py --network_dir './examples/eegnet_1d_8b_1xW/' --Bn_Relu_Bits 64 --sdk gap_sdk
...
python3 network_generate.py --network_dir './examples/eegnet_1d_8b_Hx1/' --Bn_Relu_Bits 64 --sdk gap_sdk
...
python3 network_generate.py --network_dir './examples/eegnetDW_1d_8b_1xW/' --Bn_Relu_Bits 64 --sdk gap_sdk
...
python3 network_generate.py --network_dir './examples/eegnetDW_1d_8b_Hx1/' --Bn_Relu_Bits 64 --sdk gap_sdk
...
python3 network_generate.py --network_dir './examples/SmartAgri-net/' --Bn_Relu_Bits 64 --sdk gap_sdk
...
python3 network_generate.py --network_dir './examples/MobilenetV2/' --Bn_Relu_Bits 64 --sdk gap_sdk
