...
void layerConv0(layer* layer_i) 
{
  ...
  if (snrt_is_dm_core())
  {
    ...
    DMA_copy_p_top.stride_2d = 132;
    DMA_copy_p_top.stride_1d = 4;
    DMA_copy_p_top.dir = 1;
    DMA_copy_p_top.dma_channel = NULL;

    DMA_copy_p_bottom.ext = l2_zeros;
    DMA_copy_p_bottom.hwc_to_chw = 0;
    DMA_copy_p_bottom.stride_2d = 132;
    DMA_copy_p_bottom.stride_1d = 4;
    ...
    if (0 > 0)
    {
      ...
      DMA_copy_p_top.length_1d_copy = 0*x_length_nif_byte*(0 + 1*(2==1) + 27);
      dory_dma_memcpy_async(DMA_copy_p_top);
    }

    if (4==1 && 0 > 0)
    {
      DMA_copy_p_bottom.loc = l1_buffer + (0 + 0) + x_length_nif_byte*216 + 0*x_length_nif_byte*(0 + 1*(2==1) + 27) + x_length_nif_byte*0*8 + x_length_nif_byte*1*8*(2==1);
      DMA_copy_p_bottom.number_of_2d_copies = 1;
      DMA_copy_p_bottom.number_of_1d_copies = 1;
      DMA_copy_p_bottom.length_1d_copy = 0*x_length_nif_byte*(0 + 1*(2==1) + 27);
      dory_dma_memcpy_async(DMA_copy_p_bottom);
    }

    if (0 > 0)
    {
      DMA_copy_p_left.loc = l1_buffer + (0 + 0) + 0*x_length_nif_byte*(0 + 1*(2==1) + 27);
      DMA_copy_p_left.number_of_2d_copies = 1;
      DMA_copy_p_left.number_of_1d_copies = 8;
      DMA_copy_p_left.length_1d_copy = 0*x_length_nif_byte;
      DMA_copy_p_left.stride_L1_1d = x_length_nif_byte*(0 + 1*(2==1) + 27);
      dory_dma_memcpy_async(DMA_copy_p_left);
    }

    if (2==1 && 1 > 0)
    {
      DMA_copy_p_right.loc = l1_buffer + (0 + 0) + 0*x_length_nif_byte*(0 + 1*(2==1) + 27) + x_length_nif_byte*(0 + 27);
      DMA_copy_p_right.number_of_2d_copies = 1;
      DMA_copy_p_right.number_of_1d_copies = 8;
      DMA_copy_p_right.length_1d_copy = 1*x_length_nif_byte;
      DMA_copy_p_right.stride_L1_1d = x_length_nif_byte*(0 + 1 + 27);
      dory_dma_memcpy_async(DMA_copy_p_right);
    }

    DMA_copy_x.ext = l2_x;
    DMA_copy_x.loc = l1_buffer + (0 + 0) + 0*x_length_nif_byte*(0 + 1*(2==1) + 27) + x_length_nif_byte*0;
    DMA_copy_x.number_of_2d_copies = 8;
    DMA_copy_x.number_of_1d_copies = 27;
    DMA_copy_x.length_1d_copy = x_length_nif_byte;
    DMA_copy_x.stride_L1_1d = DMA_copy_x.length_1d_copy;
    DMA_copy_x.stride_L1_2d = DMA_copy_x.length_1d_copy*DMA_copy_x.number_of_1d_copies + x_length_nif_byte*(0 + 1*(2==1));
    dory_dma_memcpy_async(DMA_copy_x);

    int cl = 0;
    W_length_nif_byte = ((cl+snrt_cluster_idx()) % CLUSTERS  == (1-1)) ? 4 : 4; 
    DMA_copy_W.ext = l2_W +448*2*snrt_cluster_idx();
    DMA_copy_W.loc = l1_buffer + (95008 + 0);
    DMA_copy_W.number_of_2d_copies = 56;
    DMA_copy_W.number_of_1d_copies = 2;
  ...
  for(iter=0; iter < total_tiles; iter++) 
  {
    ...
    db_x = !db_state_x ? 912 : 0;
    db_W = !db_state_W ? 448 : 0;
    db_y = !db_state_y ? 46592 : 0;
    exec_db_x = db_state_x ? 912 : 0;
    exec_db_W = db_state_W ? 448 : 0;
    ...
    if (snrt_is_dm_core())
    {
      if(iter < (total_tiles-1) )
      {
        ...
        x_tile_size_h   = (_i_h_load+1 == 4)   ? 8 : 8;
        x_tile_size_w   = (_i_w_load+1 == 2)   ? 6 : 27;
        ...
        W_tile_size_nof = (_i_nof_load+1 == 2) ? 8 : 56;
          ...
          if (_i_h_load == 0 && 0 > 0)
          {
            ...
            DMA_copy_p_top.number_of_2d_copies = 1;
            DMA_copy_p_top.number_of_1d_copies = 1;
            DMA_copy_p_top.length_1d_copy = 0*x_length_nif_byte*(0*(_i_w_load == 0) + 1*(_i_w_load == 1) + x_tile_size_w);
            dory_dma_memcpy_async(DMA_copy_p_top);
          }
          if (_i_h_load == 3 && 0 > 0)
          {
            DMA_copy_p_bottom.loc = l1_buffer + (0 + db_x) + x_length_nif_byte*x_tile_size_w*x_tile_size_h +  (_i_h_load == 0)*0*x_length_nif_byte*(0*(_i_w_load == 0) + 1*(_i_w_load == 1) + x_tile_size_w) + x_length_nif_byte*0*(_i_w_load == 0)*x_tile_size_h + x_length_nif_byte*1*(_i_w_load == 1)*x_tile_size_h;
            DMA_copy_p_bottom.number_of_2d_copies = 1;
            DMA_copy_p_bottom.number_of_1d_copies = 1;
            DMA_copy_p_bottom.length_1d_copy = 0*x_length_nif_byte*(0*(_i_w_load == 0) + 1*(_i_w_load == 1) + x_tile_size_w);
            dory_dma_memcpy_async(DMA_copy_p_bottom);
          }
          if (_i_w_load == 0 && 0 > 0)
          {
            DMA_copy_p_left.loc = l1_buffer + (0 + db_x) + 0*x_length_nif_byte*(0*(_i_w_load == 0) + 1*(_i_w_load == 1) + x_tile_size_w)*(_i_h_load == 0);
            DMA_copy_p_left.number_of_2d_copies = 1;
            DMA_copy_p_left.number_of_1d_copies = x_tile_size_h;
            DMA_copy_p_left.length_1d_copy = 0*x_length_nif_byte;
            DMA_copy_p_left.stride_L1_1d = x_length_nif_byte*(0*(_i_w_load == 0) + 1*(_i_w_load == 1) + x_tile_size_w);
            dory_dma_memcpy_async(DMA_copy_p_left);
          }
          if (_i_w_load == 1 && 1 > 0)
          {
            DMA_copy_p_right.loc = l1_buffer + (0 + db_x) + 0*x_length_nif_byte*(0*(_i_w_load == 0) + 1*(_i_w_load == 1) + x_tile_size_w)*(_i_h_load == 0) + x_length_nif_byte*(0*(_i_w_load == 0) + x_tile_size_w);
            DMA_copy_p_right.number_of_2d_copies = 1;
            DMA_copy_p_right.number_of_1d_copies = x_tile_size_h;
            DMA_copy_p_right.length_1d_copy = 1*x_length_nif_byte;
            DMA_copy_p_right.stride_L1_1d = x_length_nif_byte*(0*(_i_w_load == 0) + 1*(_i_w_load == 1) + x_tile_size_w);
            dory_dma_memcpy_async(DMA_copy_p_right);
          }
          DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 8, 27, 1, 32, 1,  0, 1,0, pad_offset_h, pad_offset_w, 0, 32);
          DMA_copy_x.loc = l1_buffer + (0 + db_x) + 0*x_length_nif_byte*(0*(_i_w_load == 0) + 1*(_i_w_load == 1) + x_tile_size_w)*(_i_h_load == 0) + x_length_nif_byte*0*(_i_w_load == 0);
          ...
          DMA_copy_x.length_1d_copy = x_length_nif_byte;
          DMA_copy_x.stride_L1_1d = DMA_copy_x.length_1d_copy;
          DMA_copy_x.stride_L1_2d = DMA_copy_x.length_1d_copy*DMA_copy_x.number_of_1d_copies + x_length_nif_byte*(0*(_i_w_load == 0) + 1*(_i_w_load == 1));
          dory_dma_memcpy_async(DMA_copy_x);
        // transfer of next weight tile if changed input or output channels
        if (_i_nof_load!=_i_nof_exec && (iter <  16 || snrt_cluster_idx() == (CLUSTERS-1)))
        {
          int cl = 0;
          W_length_nif_byte = ((cl+_i_nif_load+snrt_cluster_idx()) % CLUSTERS  == (1-1)) ? 4 : 4; 
          DMA_copy_W.ext = dory_get_tile_3d(l2_W,  _i_nof_load + snrt_cluster_idx() * 2, 0, 0, 56, 1*2, 1, 1*2, 1, 0,0,0,0,0,0, 32);
          DMA_copy_W.loc = l1_buffer + (95008 + db_W);
    ...
    // CREATING POINTERS TO TENSORS TO PASS TO THE KERNEL
      ...
      y_tile_size_w   = (_i_w_exec+1 == 2) ? 6 : 26;
      y_length_nof_byte = (_i_nof_exec+1 == 2)   ? 32 : 224;
      y_tile_size_nof = (_i_nof_exec+1 == 2) ? 8 : 56;
      kernel_i.pInBuffer = (float *) (l1_buffer + (0 + exec_db_x));
      kernel_i.dim_in_x = (_i_w_exec+1 == 2) ? 6 : 27;
      kernel_i.dim_in_y = (_i_h_exec+1 == 4) ? 8 : 8;
      kernel_i.ch_in = 1;
      kernel_i.pWeight = (float *) (l1_buffer + (95008 + exec_db_W));
      kernel_i.ch_out = y_tile_size_nof;
      kernel_i.dim_kernel_x = 2;
      kernel_i.dim_kernel_y = 1;
      kernel_i.padding_y_top = (_i_h_exec == 0) ? 0 : 0;
      kernel_i.padding_y_bottom = (_i_h_exec == 4-1) ? 0 : 0;
      kernel_i.padding_x_left = (_i_w_exec == 0) ? 0 : 0;
      kernel_i.padding_x_right = (_i_w_exec == 2-1) ? 1 : 0;
      kernel_i.stride_x = 1;
      kernel_i.stride_y = 1;
      kernel_i.bias = NULL;
      ...
      kernel_i.out_mult = 0;
      kernel_i.pOutBuffer = (float *) (l1_buffer + (1816 + db_y));
      kernel_i.dim_out_x = y_tile_size_w;
      kernel_i.dim_out_y = y_tile_size_h;
      kernel_i.kappa = 0;
      kernel_i.lambda = 0;
      kernel_i.pIm2ColBuffer = (float *) (l1_buffer + 95928);
      ...
      if (iter <  16 || snrt_cluster_idx() == (CLUSTERS-1))
      {
    ...
    if (snrt_is_dm_core())
    {
        ...
        y_length_nof_byte = (_i_nof_exec+1 == 2)   ? 32 : 224;
	      if (iter <  16 || snrt_cluster_idx() == (CLUSTERS-1))
	      {
    	    DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_exec, _i_w_exec, _i_nof_exec + snrt_cluster_idx() * 2, 8, 26, 56, 32, 64, 0, 0, 0, 0, 0, 0, 32);
    	    DMA_copy_y.loc = l1_buffer + (1816 + db_y);
