...
def main():
    ...
    new_node.input_channels = 16
    new_node.output_channels = 32 # = new_node.input_channels if DW
    ...
    new_node2.padding_top    = 0
    new_node2.padding_left   = 0
    new_node2.padding_bottom = 0
    new_node2.padding_right  = 0
    new_node2.input_h = 1
    new_node2.input_w = 1
    new_node2.output_h = new_node.input_h
    new_node2.output_w = new_node.input_w
    new_node2.input_channels = 32
    new_node2.output_channels = 96 # = new_node.input_channels if DW
    new_node2.outshift = 3 # don't touch
    new_node2.filter_size_h = 1
    new_node2.filter_size_w = 1
    new_node2.groups = 1 # put new_node.input_channels if DW
    new_node2.stride = 1 # don't touch
