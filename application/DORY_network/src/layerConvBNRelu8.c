...
void layerConvBNRelu8(
  ...
  if(pi_core_id()==0)
  {
    ...
    copy_lambda.id = 0;
    copy_lambda.ext = (uint32_t) l2_W+33792;
    copy_lambda.loc = (uint32_t) l1_buffer + 30480;
  ...
  for(iter=0; iter<3*1*2*8; iter++) {
    ...
    if(iter<3*1*2*8-1) 
    {
      ...
      W_tile_size_nof = (last_nof_load) ? 80 : 88;
    ...
    k = (int32_t *) (l1_buffer + 29452 + _i_nof_exec*352);
    lambda = (int32_t *) (l1_buffer + 30480 + _i_nof_exec*352);
    ...
    y_tile_size_nof = (last_nof_exec) ? 80 : 88;
    ...
    y_length_nof_byte = (last_nof_exec)   ? 80 : 88;
    p_r = 0;
    p_l = 0;
    p_t = 0;
    p_b = 0;
