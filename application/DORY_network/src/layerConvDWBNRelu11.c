...
void layerConvDWBNRelu11(
  ...
  if(pi_core_id()==0)
  {
    ...
    copy_lambda.loc = (uint32_t) l1_buffer + 32624;
  ...
  for(iter=0; iter<6*1*1; iter++) {
    ...
    last_nif_load = (_i_nof_load+1 == 6) ? 1 : 0;
    ...
    {
      asm volatile("": : :"memory");
      x_tile_size_nif = (last_nif_load) ? 16 : 48;
      ...
      x_length_nif_byte = (last_nif_load)   ? 16 : 48;
      ...
      W_tile_size_nof = (last_nof_load) ? 16 : 48;
    ...
    y_length_nof_byte = (last_nof_exec)   ? 16 : 48;
    p_r = 0;
    p_l = 0;
    p_t = 0;
    p_b = 0;
