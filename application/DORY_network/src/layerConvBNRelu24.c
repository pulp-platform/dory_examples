...
void layerConvBNRelu24(
  ...
  if(pi_core_id()==0)
  {
    ...
    copy_k.loc = (uint32_t) l1_buffer + 16652;
    ...
    copy_lambda.loc = (uint32_t) l1_buffer + 17168;
  ...
  dory_dma_memcpy_3d_custom(
  l2_W, // ext
  (l1_buffer + 8456) + 0, // loc offset caused by size of tile_x*2 (double_buffer) and tile_y*2 (double buffer)
  ...
  for(iter=0; iter<16*1*1*1; iter++) {
    ...
    k = (int32_t *) (l1_buffer + 16652 + _i_nof_exec*32);
    lambda = (int32_t *) (l1_buffer + 17168 + _i_nof_exec*32);
    W = (char *) (l1_buffer + 8456 + exec_db_W);
    ...
    pi_cl_team_barrier(0);
      ...
      mchan_barrier(dma_evt);
        ...
        dory_get_tile_3d(l2_y, _i_h_exec, _i_w_exec, _i_nof_exec, 4, 4, 8, 4, 1024, 0, 0, 0, 0, 0, 0, 8), // ext
